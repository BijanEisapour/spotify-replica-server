const ErrorMessage = {
    AUTHENTICATION_FAILED: 'احراز هویت کاربر با مشکل روبرو شد',
    ...
    PLAYLIST_NAME_REQUIRED: 'ارسال نام لیست پخش اجباری است',
    PLAYLIST_ID_REQUIRED: 'ارسال آیدی لیست پخش اجباری است',
    PLAYLIST_NOT_FOUND: 'لیست پخش مورد نظر یافت نشد',
    PLAYLIST_SONG_ALREADY_ADDED: 'آهنگ مورد نظر از قبل اضافه شده است',
    PAGE_SIZE_NOT_VALID: 'اندازۀ صفحه معتبر نیست',
    PAGE_NUMBER_NOT_VALID: 'شمارۀ صفحه معتبر نیست',
    COUNT_NOT_VALID: 'تعداد معتبر نیست',
